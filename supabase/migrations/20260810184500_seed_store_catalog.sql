...
BEGIN
  ...
  SELECT
    ...
    22.00, 19.90, 'Novedad',
    '/products/camiseta-jerusalen.jpg',
    '/products/camiseta-jerusalen.jpg',
    '/products/camiseta-jerusalen.jpg',
  ...
  INSERT INTO public.product_variants (product_id, color_name, color_hex, size, cloudinary_image_url, stock, price_adjustment, sku, metadata) VALUES
    (v_product_id, 'Negro', '#111827', 'Mediana', '/products/biblia-estudio.jpg', 8, 0, 'JER-BIB-001-BLK-M', '{"cover":"Tapa dura"}'),
    (v_product_id, 'Azul', '#1D4ED8', 'Mediana', '/products/biblia-estudio.jpg', 6, 0, 'JER-BIB-001-BLU-M', '{"cover":"Tapa dura"}'),
    (v_product_id, 'Borgoña', '#881337', 'Grande', '/products/biblia-estudio.jpg', 4, 3.00, 'JER-BIB-001-BRG-L', '{"cover":"Tapa dura"}');
  ...
  SELECT
    ...
    'JER-MUG-001', 15, true,
    '{"tags":["taza","regalo","hogar","café"],"attributes":{"Capacidad":["11 oz","15 oz"],"Acabado":["Brillante"]},"specifications":{"Material":"Cerámica","Frase":"Jesucristo es el mismo ayer, hoy y por los siglos"},"media":[{"id":"mug-main","url":"/products/taza-jerusalen.jpg","alt":"Taza cerámica","sort_order":0}]}'::jsonb
  ...
  INSERT INTO public.product_variants (product_id, color_name, color_hex, size, cloudinary_image_url, stock, price_adjustment, sku, metadata) VALUES
    (v_product_id, 'Blanco', '#F8FAFC', '11 oz', '/products/taza-jerusalen.jpg', 10, 0, 'JER-MUG-001-WHT-11', '{"finish":"Brillante"}'),
    (v_product_id, 'Blanco', '#F8FAFC', '15 oz', '/products/taza-jerusalen.jpg', 8, 2.00, 'JER-MUG-001-WHT-15', '{"finish":"Brillante"}'),
    (v_product_id, 'Negro', '#111827', '11 oz', '/products/taza-jerusalen.jpg', 7, 1.00, 'JER-MUG-001-BLK-11', '{"finish":"Mate"}'),
    (v_product_id, 'Negro', '#111827', '15 oz', '/products/taza-jerusalen.jpg', 5, 3.00, 'JER-MUG-001-BLK-15', '{"finish":"Mate"}');
END $$;
