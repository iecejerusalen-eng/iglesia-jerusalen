...
BEGIN
  ...
  SELECT id INTO product_id FROM public.products WHERE sku = 'JER-TEE-001';
  DELETE FROM public.product_variants pv WHERE pv.product_id = product_id AND pv.sku LIKE 'JER-TEE-001-%';
  INSERT INTO public.product_variants (product_id, color_name, color_hex, size, cloudinary_image_url, stock, price_adjustment, sku, metadata) VALUES
    (product_id, 'Negro', '#111827', 'S', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1000&q=85', 6, 0, 'JER-TEE-001-BLK-S', '{"fit":"Regular"}'),
    (product_id, 'Negro', '#111827', 'M', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1000&q=85', 8, 0, 'JER-TEE-001-BLK-M', '{"fit":"Regular"}'),
    (product_id, 'Negro', '#111827', 'L', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1000&q=85', 7, 1.00, 'JER-TEE-001-BLK-L', '{"fit":"Regular"}'),
    (product_id, 'Negro', '#111827', 'XL', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1000&q=85', 4, 1.50, 'JER-TEE-001-BLK-XL', '{"fit":"Regular"}'),
    (product_id, 'Blanco', '#F8FAFC', 'S', 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&w=1000&q=85', 4, 0, 'JER-TEE-001-WHT-S', '{"fit":"Regular"}'),
    (product_id, 'Blanco', '#F8FAFC', 'M', 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&w=1000&q=85', 6, 0, 'JER-TEE-001-WHT-M', '{"fit":"Regular"}'),
    (product_id, 'Blanco', '#F8FAFC', 'L', 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&w=1000&q=85', 3, 1.00, 'JER-TEE-001-WHT-L', '{"fit":"Regular"}'),
    (product_id, 'Azul Jerusalén', '#1D4ED8', 'M', 'https://images.unsplash.com/photo-1627225924765-552d49cf47ad?auto=format&fit=crop&w=1000&q=85', 4, 1.00, 'JER-TEE-001-BLU-M', '{"fit":"Regular"}'),
    (product_id, 'Azul Jerusalén', '#1D4ED8', 'L', 'https://images.unsplash.com/photo-1627225924765-552d49cf47ad?auto=format&fit=crop&w=1000&q=85', 4, 1.00, 'JER-TEE-001-BLU-L', '{"fit":"Regular"}');
  ...
  SELECT id INTO product_id FROM public.products WHERE sku = 'JER-BIB-001';
  DELETE FROM public.product_variants pv WHERE pv.product_id = product_id AND pv.sku LIKE 'JER-BIB-001-%';
  INSERT INTO public.product_variants (product_id, color_name, color_hex, size, cloudinary_image_url, stock, price_adjustment, sku, metadata) VALUES
    (product_id, 'Negro', '#111827', 'Mediana', 'https://images.unsplash.com/photo-1504052434569-70ad5836ab65?auto=format&fit=crop&w=1000&q=85', 8, 0, 'JER-BIB-001-BLK-M', '{"cover":"Tapa dura"}'),
    (product_id, 'Azul', '#1D4ED8', 'Mediana', 'https://images.unsplash.com/photo-1504052434569-70ad5836ab65?auto=format&fit=crop&w=1000&q=85', 6, 0, 'JER-BIB-001-BLU-M', '{"cover":"Tapa dura"}'),
    (product_id, 'Borgoña', '#881337', 'Grande', 'https://images.unsplash.com/photo-1504052434569-70ad5836ab65?auto=format&fit=crop&w=1000&q=85', 4, 3.00, 'JER-BIB-001-BRG-L', '{"cover":"Tapa dura"}');
  ...
  SELECT id INTO product_id FROM public.products WHERE sku = 'JER-MUG-001';
  DELETE FROM public.product_variants pv WHERE pv.product_id = product_id AND pv.sku LIKE 'JER-MUG-001-%';
  INSERT INTO public.product_variants (product_id, color_name, color_hex, size, cloudinary_image_url, stock, price_adjustment, sku, metadata) VALUES
    (product_id, 'Blanco', '#F8FAFC', '11 oz', 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?auto=format&fit=crop&w=1000&q=85', 10, 0, 'JER-MUG-001-WHT-11', '{"finish":"Brillante"}'),
    (product_id, 'Blanco', '#F8FAFC', '15 oz', 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?auto=format&fit=crop&w=1000&q=85', 8, 2.00, 'JER-MUG-001-WHT-15', '{"finish":"Brillante"}'),
    (product_id, 'Negro', '#111827', '11 oz', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1000&q=85', 7, 1.00, 'JER-MUG-001-BLK-11', '{"finish":"Mate"}'),
    (product_id, 'Negro', '#111827', '15 oz', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1000&q=85', 5, 3.00, 'JER-MUG-001-BLK-15', '{"finish":"Mate"}');
END $$;
