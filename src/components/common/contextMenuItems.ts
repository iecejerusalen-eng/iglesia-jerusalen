...
export const CONTEXT_MENU_GROUPS: ContextMenuGroupDef[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/publicaciones',
        iconKey: 'FileText',
        colorClasses: 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400',
      },
      {
        type: 'nav',
        label: 'Ministerios y departamentos',
        path: '/ministerios',
        iconKey: 'UsersRound',
        colorClasses: 'bg-cyan-50 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400',
      },
      {
        type: 'nav',
        label: 'Alabanzas',
        ...
        iconKey: 'Music2',
        colorClasses: 'bg-fuchsia-50 dark:bg-fuchsia-900/30 text-fuchsia-600 dark:text-fuchsia-400',
      },
      {
        type: 'nav',
        label: 'Misiones 3D',
