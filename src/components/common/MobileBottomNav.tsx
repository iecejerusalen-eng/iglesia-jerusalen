          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-gray-800 dark:text-gray-200">Misiones 🌍</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Impacto global del Evangelio</div>
                </div>
              </Link>
            </div>
          </div>
