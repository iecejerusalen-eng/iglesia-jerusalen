    ...
    <div className="relative flex flex-col md:flex-row items-center w-full">
      ...
      <div className={`w-full md:w-1/2 pl-20 md:pl-0 ${isEven ? 'md:pr-24 md:text-right' : 'md:pl-24 md:order-last'}`}>
        ...
        >
          ...
          <h3 className="text-2xl md:text-3xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-3">
            {step.title}
          </h3>
          <p className="text-slate-900 dark:text-slate-300 leading-relaxed text-sm md:text-base font-medium">
            {step.description}
          </p>
        </AnimeFadeUp>
      </div>
