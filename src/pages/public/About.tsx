    ...
    <main className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-indigo-50/50 px-4 py-6 dark:from-slate-950 dark:via-slate-950 dark:to-indigo-950/30 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-6 lg:grid-cols-[220px_minmax(0,1fr)]">
        ...
        <section className="relative mb-12 overflow-hidden rounded-[2rem] border border-white/15 bg-slate-950 px-6 py-12 text-white shadow-2xl sm:px-12 lg:px-16 lg:py-16">
          <img src={churchFacadePhoto} alt="Fachada de la Iglesia Jerusalén" className="absolute inset-0 h-full w-full object-cover opacity-30" />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(2,8,23,.97),rgba(7,21,47,.82),rgba(7,21,47,.48)),radial-gradient(circle_at_80%_10%,rgba(245,180,54,0.28),transparent_35%)]" />
