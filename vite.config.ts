    ...
    VitePWA({ 
      ...
      injectManifest: {
        ...
        globIgnores: [
          ...
          '**/images/bible/**',
          '**/assets/encyclopedia/**',
          // El panel administrativo se carga con lazy routes y no debe
          // instalarse en el dispositivo de cada visitante público.
          '**/assets/*Manager-*.js',
          '**/assets/Admin*.js',
          '**/assets/*Dashboard*.js',
          '**/assets/*Editor*.js',
