...
exports.BIBLE_BOOK_MAP = {
    ...
    // Evangelios
    'mateo': 'mateo', 'mt': 'mateo', 'san mateo': 'mateo',
    'marcos': 'marcos', 'mr': 'marcos', 'mc': 'marcos', 'san marcos': 'marcos',
    'lucas': 'lucas', 'lc': 'lucas', 'lu': 'lucas', 'san lucas': 'lucas',
    'juan': 'juan', 'jn': 'juan', 'san juan': 'juan',
    // Historia
...
function parseBibleReferences(text) {
    ...
    for (const part of parts) {
        ...
        if (match) {
            ...
            const bookId = exports.BIBLE_BOOK_MAP[normalizedBook] || exports.BIBLE_BOOK_MAP[rawBookName.toLowerCase()] || rawBookName.toLowerCase().replace(/\s+/g, '');
            results.push({
                original: part,
                bookId,
